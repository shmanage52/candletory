...
1. Clone this repository:
    ```
    git clone https://github.com/shmanage52/candletory.git
    cd candletory
    ```
...
- **Instagram**: [@candletory1](https://www.instagram.com/candletory1/)
- **YouTube**: [Candletory Channel](https://www.youtube.com/channel/UCs-ihj8ECgPHoFXJArYWXNQ)
